...
function configureProductionLogger(options) {
  try {
    const { permittedCSP, cspConfig, useCORSDevOverride = true, useCSP = true, useHelmet = true, aws_key, aws_secret, subscriber, topic_arn, region,  useNewrelicLog = true, SNSLogLevel='info', } = options;
    const env = this.settings.application.environment;
